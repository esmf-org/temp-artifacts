...
ESMF_VERSION_STRING_GIT=v8.4.0b05-10-g2a13bec76f
#----------------------------------------------
...
ESMF_APPSDIR=/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/apps/appsO/Darwin.gfortran.64.openmpi.default
ESMF_LIBSDIR=/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default
...
ESMF_F90COMPILEPATHS=-I/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/mod/modO/Darwin.gfortran.64.openmpi.default -I/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/src/include -I/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/include -I/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.4.0b05-10-g2a13bec76f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Darwin=1 -DESMF_COMM=openmpi -DESMF_DIR=/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf
...
ESMF_F90LINKPATHS=-L/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default -L/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/lib -L/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/lib -L/opt/local/lib/gcc11/gcc/x86_64-apple-darwin21/11.2.0/../../../
ESMF_F90ESMFLINKPATHS=-L/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default
ESMF_F90LINKRPATHS=
ESMF_F90ESMFLINKRPATHS=-L/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/src/include  -I/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/include -I/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.4.0b05-10-g2a13bec76f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Darwin=1 -DESMF_COMM=openmpi -DESMF_DIR=/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread  -fopenmp
ESMF_CXXLINKPATHS=-L/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default -L/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/lib -L/project/esmf/stack/install/gcc/11.2.0/netcdf/4.7.4/lib -L/opt/local/lib/gcc11/gcc/x86_64-apple-darwin21/11.2.0/../../../
ESMF_CXXESMFLINKPATHS=-L/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default
ESMF_CXXLINKRPATHS=
ESMF_CXXESMFLINKRPATHS=-L/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default
...
ESMF_TRACE_LDPRELOAD=/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf/lib/libO/Darwin.gfortran.64.openmpi.default/libesmftrace_preload.dylib
...
ESMF_INTERNAL_DIR=/project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf
ESMF_INTERNAL_MPIRUN="mpirun --oversubscribe"

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /project/esmf/rocky/esmf-test-dev/gfortran_11.2.0_openmpi_O_develop/esmf
# ESMF_OS: Darwin
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
